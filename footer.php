    ...
    <div class="footer__columns">
      <div class="footer__col">
        <h3 class="footer__col-title">
          <i data-feather="shopping-bag"></i> <span>Gam.co</span></h3>
      ...
      <div class="footer__col">
        <h3 class="footer__col-title">
          <i data-feather="send"></i> <span>Contacto</span></h3>
        <nav class="footer__nav">
          <ul class="footer__nav-list">
            <li class="footer__nav-item">
              <a href="mailto:contact.laboiserie@gmail.com" class="footer__nav-link">
                contact.gamco@gmail.com
              </a>
            </li>
          </ul>
        </nav>
      ...
      <div class="footer__copyrights">
        <p>Esto es un proyecto escolar:<a href= >@Aaron,@Zuirel,@Christian,@Diego,@Julio</a></p>
      </div>
  </div>
</footer>
<!-- partial -->
  <script src='https://unpkg.com/feather-icons'></script><script  src="./js/script_foo.js"></script>
