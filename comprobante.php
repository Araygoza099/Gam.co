...
<head>
    ...
    <title>Comprobante de Compra | Gam.co</title>
...
<body>
    ...
    <div class="container">
         <div class="corner-image">
          ...
          <div class="buttons">
            <a href="crearpdf.php"><button style="margin-top: 20px;">PDF</button></a> 
            <a href="ticketCorreo.php"><button style="margin-top: 20px;">Correo</button></a>
