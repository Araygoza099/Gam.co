...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2023 at 04:58 AM
...
INSERT INTO `det_pedido` (`detpedido_id`, `proc_id`, `pedido_id`, `detpedido_cantidad`, `prec_unitario`) VALUES
(1, 1, NULL, 1, 1169),
(2, 2, NULL, 1, 650),
(3, 6, NULL, 1, 1500),
(4, 1, NULL, 1, 1169),
...
(2, 2, 'Acacia 516', 'Las Arboledas', 20020, 'Aguascalientes', 'Aguascalientes', 4493732345),
(3, 2, 'Av Universidad', 'Bosques del Prado', 20030, 'Aguascalientes', 'Aguascalientes', 4499145685);
...
CREATE TABLE `pagos` (
  ...
  `card_thought` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pagos` (`pago_id`, `usr_id`, `card_name`, `card_number`, `card_thought`) VALUES
(0, 1, '', '0000000000000000', '2030-01-01'),
(1, 2, 'Aux', '0000000000', '00/00'),
(2, 2, 'Christian Escamilla', '1526485915263656', '01/27'),
(3, 2, 'John Dalton', '1526485915262626', '02/24'),
(4, 2, 'Chris Escamilla', '4564654654654654', '01/25'),
(5, 2, 'Chris Escamilla', '4564654654654654', '01/25'),
(6, 2, 'Chris Escamilla', '4564654654654654', '01/25'),
(7, 2, 'Chris Escamilla', '4564654654654654', '01/25'),
(8, 2, 'Chris Escamilla', '4564654654654654', '01/25'),
(9, 2, 'Chris Escamilla', '4564654654654654', '01/25'),
(10, 2, 'Chris Escamilla', '4564654654654654', '01/25');
...
(1, 'Resident Evil 4 - Remake', 'Seis años después de la catástrofe en Raccoon City, el agente Leon S. Kennedy es enviado a rescatar a la hija del presidente, secuestrada en una apartada población europea. La historia sigue un arriesgado rescate lleno de terror, explorando la intersecció', 10, 1299, 1, 'ResidentEvil4.webp', 'Videojuegos'),
(2, 'Red Dead Redemption 2', 'Arthur Morgan y la banda de Van der Linde son forajidos buscados. Con agentes federales y los mejores cazarrecompensas pisándoles los talones, la banda deberá abrirse camino por el salvaje territorio del corazón de Estados Unidos a base de robos y peleas ', 50, 1300, 46, 'img1.2.jpeg', 'Videojuegos'),
...
(4, 'Cuphead', 'Juega como Cuphead o Mugman (en modo de un jugador o cooperativo) y cruza mundos extraños, adquiere nuevas armas, aprende poderosos supermovimientos y descubre secretos ocultos mientras procuras saldar tu deuda con el diablo.', 30, 400, 0, 'img1.4.jpg', 'Videojuegos'),
...
(6, 'Cyberpunk 2077', 'Cyberpunk 2077 es un RPG de acción y aventura de mundo abierto ambientado en el futuro sombrío de Night City, una peligrosa megalópolis obsesionada con el poder, el glamur y las incesantes modificaciones corporales.', 0, 1500, 48, 'img1.5.jpg', 'Videojuegos'),
...
(16, 'Convertidor de Teclado', 'El adaptador de teclado y mouse KX es un producto innovador que permite a los jugadores disfrutar de juegos FPS en diferentes dispositivos con teclado USB y mouse.', 80, 399, 0, 'ConvetidorTeclado.jpg', 'Accesorios'),
...
(19, 'Soporte de Nintendo Switch Zelda Tears of The Kingdom', 'Este producto combina el diseño para las lágrimas del reino, y la apariencia es muy única y utiliza material ABS de alta calidad.', 5, 499, 18, 'SoporteNSzelda.jpg', 'Accesorios'),
